    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        if (mDetectorType == JAVA_DETECTOR) {
            if (mJavaDetector != null)
                mJavaDetector.detectMultiScale(mGray, faces, 1.2, 2, 2, // TODO: objdetect.CV_HAAR_SCALE_IMAGE
        ...
        if (/*!faces.empty()*/ true) {
            ...
            points.alloc(140);
            faceDetector.detectLandmark(mGray.nativeObj, points.nativeObj);
            ...
            Imgproc.rectangle(mRgba, new Point(pointsArray[136].x,pointsArray[137].x), new Point(pointsArray[138].x,pointsArray[139].x), FACE_RECT_COLOR, 3);
